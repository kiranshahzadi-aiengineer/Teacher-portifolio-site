...
document.querySelectorAll('.edu-card, .info-card, .experience-item, .skills-category').forEach(element => {
...
statItems.forEach((item, index) => {
    item.style.animation = `fadeInUp 0.8s ease ${0.8 + (index * 0.2)}s backwards`;
});

// Add hover effect to qualification items
